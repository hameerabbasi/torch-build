...
export USE_PER_OPERATOR_HEADERS=${USE_PER_OPERATOR_HEADERS:-1}
export CCACHE_COMPRESS=${CCACHE_COMPRESS:-true}
export CCACHE_SLOPPINESS=${CCACHE_SLOPPINESS:-pch_defines,time_macros}  # Necessary for precompiled headers
# General utils
export USE_KINETO=${USE_KINETO:-1}                               # profiler
export USE_CUDNN=${USE_CUDNN:-1}                                # CNNs
